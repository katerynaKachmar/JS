...
// console.log(charAt);
//
// let replace = str.replace(/ /g, 'hehehe');
// let someArr = [1,4,7,3,7,5,6];
// let splice = someArr.splice(1,5);
// console.log(splice);
// let sliceArr = someArr.slice(1,5);
...
// let arrCharAt = someArr.charAt(8);
// console.log(arrCharAt);
